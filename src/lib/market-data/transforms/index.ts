...
import type { AlpacaBar, AlpacaSnapshot } from "../providers/alpaca";
...
export function mapAlpacaSnapshotQuote(
  ...
  if (!snap) return null;
  // Never fabricate a quote: use Alpaca's latest trade or daily close and
  // require a real previous close before calculating the session change.
